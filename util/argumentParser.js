...
// ========
module.exports = {
    parse: function (options, client, argumentString, guild, author, textChannel) {
        ...
        for (a = 0; a < argumentList.length; a++) {
            ...
            if (argument == "--help" || argument == "-h") {
                ...
                const embed = {
                    ...
                    embeds: [{
                                ...
                                "fields": [
                                    ...
                                    {
                                    "name": "Support",
                                    "value": "If you need help, contact Bloggi#7559."
                                    }
                                ]
                    }]
                };
                ...
                var candidates = getAudio(value, false);
                var candidatesNames = getAudio(value, true);
                ...
                */
                ...
                if (candidates.length == 0) {
                    // no match found, cant continue
                    options.abort = true;
                    textChannel.send("You entered an unknown argument (" + argument + "). Please enter `!hob --help` to view a list of commands.");
...
function getAudio(pattern, shorten) {
